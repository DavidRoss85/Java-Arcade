...
public class MidiPlayerTest1 {
    ...
    public static void main(String[] args)
    {
        ...
        MidiPlayerTest1 player = new MidiPlayerTest1();
    ...
    public void setUpPlayer(int numOfNotes)
    {
        ...
        try {
            ...
            for (int i = 5; i < (4 * numOfNotes) + 5; i += 4)
            {
                ...
                tmpNote=i%100+50;
                // Add Note On event
                track.add(makeEvent(144, 1, tmpNote, 100, i));

                // Add Note Off event
                track.add(makeEvent(128, 1, tmpNote, 100, i + 2));
            }
